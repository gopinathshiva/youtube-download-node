				...
				<?php
					...
					if ( get_option( 'woocommerce_enable_review_rating' ) === 'yes' ) {
						$comment_form['comment_field'] = '<p class="comment-form-rating"><label for="rating">' . __( 'Your Rating', 'woocommerce' ) .'</label><select name="rating" id="rating">
							...
							<option value="5">' . __( 'מעולה', 'woocommerce' ) . '</option>
							<option value="4">' . __( 'טוב', 'woocommerce' ) . '</option>
							<option value="3">' . __( 'ממוצע', 'woocommerce' ) . '</option>
							<option value="2">' . __( 'לא רע', 'woocommerce' ) . '</option>
							<option value="1">' . __( 'רע מאוד', 'woocommerce' ) . '</option>
						</select></p>';
					}
