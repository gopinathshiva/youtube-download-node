...
<!--AlbertMax @ Fiverr.com-->
<script type="text/javascript">
jQuery(document).ready(function(){
	var prdctfltr_columns = jQuery('.prdctfltr_filter').length;
	if (prdctfltr_columns == 1){
		jQuery('.prdctfltr_filter:nth-child(1)').css('width', '100%');
		jQuery('.prdctfltr_filter:nth-child(2)').css('width', '100%');
		jQuery('.prdctfltr_filter:nth-child(3)').css('width', '100%');
	} else if (prdctfltr_columns == 2){
		jQuery('.prdctfltr_filter:nth-child(1)').css('width', '84%');
		jQuery('.prdctfltr_filter:nth-child(2)').css('width', '15%');
	} else if (prdctfltr_columns == 3){
		jQuery('.prdctfltr_filter:nth-child(1)').css('width', '69%');
		jQuery('.prdctfltr_filter:nth-child(2)').css('width', '15%');
		jQuery('.prdctfltr_filter:nth-child(3)').css('width', '15%');
	} else if (prdctfltr_columns == 4){
		jQuery('.prdctfltr_filter:nth-child(1)').css('width', '54%');
		jQuery('.prdctfltr_filter:nth-child(2)').css('width', '15%');
		jQuery('.prdctfltr_filter:nth-child(3)').css('width', '15%');
		jQuery('.prdctfltr_filter:nth-child(4)').css('width', '15%');
	} else if (prdctfltr_columns == 5){
		jQuery('.prdctfltr_filter:nth-child(1)').css('width', '39%');
		jQuery('.prdctfltr_filter:nth-child(2)').css('width', '15%');
		jQuery('.prdctfltr_filter:nth-child(3)').css('width', '15%');
		jQuery('.prdctfltr_filter:nth-child(4)').css('width', '15%');
		jQuery('.prdctfltr_filter:nth-child(5)').css('width', '15%');
	} else if (prdctfltr_columns == 6){
		jQuery('.prdctfltr_filter:nth-child(1)').css('width', '24%');
		jQuery('.prdctfltr_filter:nth-child(2)').css('width', '15%');
		jQuery('.prdctfltr_filter:nth-child(3)').css('width', '15%');
		jQuery('.prdctfltr_filter:nth-child(4)').css('width', '15%');
		jQuery('.prdctfltr_filter:nth-child(5)').css('width', '15%');
		jQuery('.prdctfltr_filter:nth-child(6)').css('width', '15%');
	}
});
</script>
</body>
